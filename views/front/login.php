              ...
              <div>
                <div class="mx-auto text-center py-5">
                  <form action="#">
                    ...
                    <input class="form-control mb-2" name="password" type="password" placeholder="Mot de passe">
                    <button class="btn btn-primary py-2 w-100 mb-3">je me connecte</button>
                    <a class="d-inline-block link-secondary mb-4" href="index.php?action=forgotpassword"><small>Mot de passe oublié ?</small></a>
                  </form>
                </div>
              </div>
            </div>
